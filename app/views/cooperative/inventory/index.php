...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <a href="<?= APP_URL ?>/cooperative/inventory/create" class="btn btn-success btn-sm">
  ...
  <div class="card-body py-2">
    <form method="GET" class="row g-2 align-items-end">
      ...
      <div class="col-auto">
        ...
        <a href="<?= APP_URL ?>/cooperative/inventory" class="btn btn-outline-secondary btn-sm">Reset</a>
      </div>
    </form>
  </div>
</div>
...
<div class="card border-0 shadow-sm rounded-3">
    ...
    <div class="table-responsive">
      <table class="table table-hover align-middle mb-0">
        <thead class="table-light">
          <tr><th>Crop</th><th>Warehouse</th><th>Available</th><th>Reserved</th><th>Sold</th><th>Grade</th><th>Asking Price</th><th>Status</th><th>Actions</th></tr>
        </thead>
        <tbody>
          ...
          <tr>
            ...
            <td><span class="badge bg-success">Grade <?= $item['grade'] ?></span></td>
            <td class="fw-semibold"><?= Helper::formatCurrency($item['asking_price']) ?>/kg</td>
            <td><?= Helper::statusBadge($item['status']) ?></td>
            <td>
              <a href="<?= APP_URL ?>/cooperative/inventory/<?= $item['id'] ?>/edit" class="btn btn-xs btn-outline-primary">
          ...
          <tr><td colspan="9" class="text-center text-muted py-4">No inventory records. <a href="<?= APP_URL ?>/cooperative/inventory/create">Add stock</a></td></tr>
          <?php endif; ?>
        </tbody>
      </table>
    </div>
  ...
  <div class="card-footer bg-white d-flex justify-content-between align-items-center">
    ...
    <?= Helper::paginate($result, APP_URL . '/cooperative/inventory') ?>
  </div>
  <?php endif; ?>
</div>
